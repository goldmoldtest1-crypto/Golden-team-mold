    ...
    <div className="flex flex-col min-h-screen font-sans text-slate-900 bg-[#f8fffd]">
           ...
           <div className="absolute top-8 left-8 bg-white/95 backdrop-blur px-6 py-4 rounded-2xl shadow-2xl border border-teal-50">
              <div className="flex items-center gap-4">
                 ...
                 <div className="flex flex-col">
                    <span className="font-black text-2xl text-[#2d4a53] tracking-tighter leading-none text-center md:text-left uppercase">Golden</span>
                    <span className="font-black text-2xl text-[#2d4a53] tracking-tighter leading-none text-center md:text-left uppercase">Team</span>
                 </div>
              </div>
           </div>
        </div>
      ...
      <section id="services" className="px-6 py-20 bg-white border-y border-teal-50">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16">
          <div>
            <h3 className="text-xl font-black uppercase tracking-widest text-[#2d4a53] mb-2 border-b-4 border-[#48c9b0] inline-block pb-1 text-left">
            ...
            <p className="mt-16 text-[#48c9b0] font-black text-3xl uppercase tracking-tighter text-center md:text-left">Results in 24 hours</p>
          </div>

          <div className="bg-[#f0f9f7] p-8 md:p-12 rounded-[2rem] shadow-sm text-[#2d4a53]">
          ...
          <div className="p-8 md:p-16">
            ...
            {submitted ? (
              <div className="bg-teal-50 p-12 rounded-3xl text-center">
                ...
                <h4 className="text-2xl font-bold text-[#2d4a53]">Success!</h4>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <textarea rows={4} placeholder="Message" className="w-full px-6 py-4 bg-slate-50 rounded-2xl border-none outline-none focus:ring-2 focus:ring-teal-500 resize-none" value={formData.message} onChange={e => setFormData({...formData, message: e.target.value})}></textarea>
      ...
      <footer className="bg-white py-12 px-6 text-center border-t border-teal-50 text-xs font-bold text-[#2d4a53]">
        <a href="https://www.Goldenteammold.com" className="uppercase tracking-widest mb-4 block">www.Goldenteammold.com</a>
        <a href="mailto:Goldmoldtest1@gmail.com" className="underline decoration-[#48c9b0] underline-offset-4">Goldmoldtest1@gmail.com</a>
      </footer>
    </div>
  )
}
